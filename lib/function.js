...
global.api = "https://api.giftedtech.co.ke/api"; // wow you brought them here
...
module.exports = {  GiftedAnticall, GiftedFancy, Giftedttstalk, giftedCdn, loadBase64Session, makeId, convertStickerToImage, GiftedApkDl, giftedTempmail, getBuffer, monospace, getGroupAdmins, getRandom, h2k, isUrl, Json, runtime, sleep , toAudio, toPTT, eBasef, dBasef, eBinary, dBinary, toVideo, ffmpeg, fetchJson, getTempMail,
    getTempMailInbox,
    getTempMailMessage };

...
gmd({ 
    ...
    filename: __filename 
}, async (Aliconn, mek, m, { from, prefix, quoted, q, reply }) => { 
    try { 
...
*ғꪮʀ ʏꪮꪊ ғꪮʀ ᴀʟʟ ꪮғ ᴀꜱ 🍉*`;
        ...
        const videoMsg = await Aliconn.sendMessage(from, { image: { url: yts.thumbnail }, caption: ytmsg }, { quoted: mek });
...
gmd({ 
    ...
    use: '.song <query>', 
    filename: __filename 
}, async (Aliconn, mek, m, { from, sender, reply, q }) => { 
    try {
